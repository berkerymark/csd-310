...
def add_films(cursor, title):
    cursor.execute('''INSERT INTO film(film_id, film_name, film_releaseDate, film_runtime, film_director, studio_id,
    genre_id) VALUES (4,'Star Wars: Episode IV- A New Hope','1977',121,'George Lucas',1,2)''')
    db.commit()
...
update_films(cursor, "DISPLAYING FILMS AFTER UPDATE- Changed Alien to Horror")
